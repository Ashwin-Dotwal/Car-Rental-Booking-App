...
const Testimonial = () => {
        ...
        {  name: "Emma Rodriguez", location: "Mumbai,MH", 
          ...
          image: assets.testimonial_image_2,
           ...
           testimonial: "CarRental made my trip so much easier. The car was delivered right to my door, and the customer service was fantastic!"
            ...
            {  name: "Ava Johnson", location: "Noida,UP", 
  ...
  return (
    <div className="py-28 px-6 md:px-16 lg:px-24 xl:px-44">
             ...
             <Titel title="What Our Customer Say" subTitel="Discover why discerning travelers choose StayVenture for their luxury accommdations around the world."/>
