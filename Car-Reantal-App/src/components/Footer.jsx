...
const Footer = () => {
  return (
    <div className="px-6 mdpx-16 lg:px-24 xl:px-32 mt-60 text-sm text-gray-500">
      <div className="flex flex-wrap justify-between items-start gap-8 pb-6 border-borderColor border-b">
        <div>
          <img src={assets.logo} alt="logo" className="h-8 md:h-9" />
          <p className="max-w-80 mt-3">
            Premium car rental service with a wide selection of luxury and
            everyday for all your driving needs.
          </p>
        ...
        <div>
          ...
          <ul className="mt-3 flex flex-col gap-1.5">
            <li>Office No. 204, C21 Business Park, Vijay Nagar</li>
            <li> Indore – 452010 M.P India</li>
            <li>+91 6260476245</li>
            <li> Info@CarRentalgmail.com</li>
          </ul>
        </div>
      </div>
